<script setup>
import { ref } from "vue";
import { InputText, TextArea, InputSelect, FileUpload, RadioInput, Checkbox, Toggle, Button } from '@gemamaulana/vue-kit-ui';import Header from "../components/header.vue";
...
<template>
    <div class="min-h-screen flex flex-col pt-0">
        <Header class="mb-4" />
        <div class="flex-grow bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
