...
<template>
    <div :class="horizontal ? 'flex items-center gap-4 mb-4' : 'flex flex-col mb-4'">
        <label
            :class="horizontal ? 'text-sm font-semibold text-gray-800 w-40' : 'text-sm font-semibold text-gray-800 mb-1'">
            {{ label }}
